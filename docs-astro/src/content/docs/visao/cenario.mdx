...
[Link para o diagrama no Canva](https://www.canva.com/design/DAGzEg3Z9Ro/GjPasH6fVHmBAdKcDYdPmA/edit?utm_content=DAGzEg3Z9Ro&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton)
...
<ul class="softex-flow">
  <li> <strong>Redução de conflitos</strong> de reserva em 90%</li>
  <li><strong>Economia de tempos</strong> administrativo de 60%</li>
  <li><strong>Visibilidade completa</strong> da ocupação</li>
  <li><strong>Decisões baseadas</strong> em dados reai</li>
  <li><strong>Integração</strong> com ecossistema corporativo</li>
  <li><strong>Compliance</strong> com políticas internas</li>
</ul>