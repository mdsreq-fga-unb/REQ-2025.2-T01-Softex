...
const filtroStatus = ref<"todos" | "aprovado" | "recusado" | "cancelado">(
  "todos"
);
...
const reservaEstaNoIntervalo = (reserva: ReservaSala): boolean => {
  ...
  if (filtroDataInicio.value && filtroDataFim.value) {
    return (
      reservaIso >= filtroDataInicio.value && reservaIso <= filtroDataFim.value
    );
  }
  ...
  <div class="salas-container min-h-screen">
    ...
    <div class="dashboard-content">
      <div class="dashboard-grid">
        ...
        <div class="card">
          <h2 class="card-title">
            <span v-if="activeTab === 'solicitacoes'"
              >Solicitações de salas</span
            >
          ...
          <template v-if="activeTab === 'solicitacoes'">
            ...
            >
              ...
              <p class="empty-hint">
                Assim que alguém solicitar uma sala de reunião, ela aparecerá
                aqui para análise.
              </p>
            </div>
            ...
            <div v-else class="lista-reservas">
              ...
              >
                ...
                <div class="reserva-meta">
                  <span
                    class="badge status"
                    :class="resultadoClass(reserva.status)"
                  >
          ...
          <template v-else>
            ...
            <div
              v-if="reservasConcluidasFiltradas.length === 0"
              class="empty-state"
            >
              <p>Nenhuma reserva encontrada para os filtros selecionados.</p>
              <p class="empty-hint">
                Ajuste o período ou a ordenação para visualizar outras reservas
                concluídas.
              </p>
            </div>
